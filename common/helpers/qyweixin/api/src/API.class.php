...
abstract class API
{
    ...
    const USER_LIST         = '/cgi-bin/user/list_id?access_token=ACCESS_TOKEN';
    ...
    const GORP_TAG_GET_LIST      = '/cgi-bin/externalcontact/get_corp_tag_list?access_token=ACCESS_TOKEN';
    const GORP_TAG_SAVE     = '/cgi-bin/externalcontact/mark_tag?access_token=ACCESS_TOKEN';

    const EXT_USER_GET_LIST      = '/cgi-bin/externalcontact/list?access_token=ACCESS_TOKEN';
    const EXT_USER_GET_DETAIL      = '/cgi-bin/externalcontact/get?access_token=ACCESS_TOKEN';
