...
{
    private $result = ['notify/ask','user/login','user/code','user/wx-user-info','article/view','baby/collection-list','index/index'];
    protected $userid = 0;
    protected $user;
    ...
    public function beforeAction($action)
    {
        ...
        if($this->seaver_token)
        {
            ...
            if( $session[0]) {
                $userLogin = UserLogin::findOne(['dopenid' => $session[0]]);
