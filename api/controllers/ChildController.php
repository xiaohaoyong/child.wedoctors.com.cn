    ...
    public function afterAction($action, $result)
    {
        ...
        if($controllerID."/".$actionID == 'child/five' || $controllerID."/".$actionID == 'child/confirm'){
            ...
            if($doctorParent) {
                ...
                if(in_array($doctor->county,[1106,1105]) || in_array($doctorParent->doctorid,[143296,118080,126118,126122,160226,113896,113478,91722,175877,176156,184741,184793,190922,192821,194606,206259,206262,206260,213579,213390,213581,216592,216593,216594,219333,221895,223413,228039,240074,240185,240188,240189,240191])) {
