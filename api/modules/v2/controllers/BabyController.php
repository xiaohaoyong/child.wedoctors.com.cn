...
class BabyController extends \api\modules\v1\controllers\BabyController
{
    public function actionCollectionList()
    {
        $query=BabyToolLike::find()->andFilterWhere(['loginid'=>$this->userLogin->id])->andFilterWhere(['type'=>2]);
        $totle=$query->count();
