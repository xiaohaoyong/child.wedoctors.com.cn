                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    ...
                                    <?= $form->field($appointcomment, 'hospitalid')->dropdownList(\common\models\UserDoctor::find()->select('name')->indexBy('userid')->andFilterWhere(['>', 'userid', '37'])->andFilterWhere(['county' => \Yii::$app->user->identity->county])->column(), ['prompt' => '请选择']) ?>
