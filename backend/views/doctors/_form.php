    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php $hospitalid=\common\models\DoctorHospital::find()->select('hospitalid')->where(['doctorid'=>$model->userid])->column();?>



                <div class="form-group">
                    <div class="col-lg-3 control-label color666 fontweight"><label class="control-label">关联社区</label>:</div>
                    <div class="col-lg-5" style="padding-left: 15px;padding-right: 15px;">
                        <?= \kartik\select2\Select2::widget([
                            'name' => 'hospitalid',
                            'data' => \common\models\UserDoctor::find()->select('name')->indexBy('hospitalid')->column(),
                            'language' => 'de',
