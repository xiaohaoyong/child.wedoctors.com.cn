...
class ChildSearch extends ChildInfo
{
    ...
    public function search($params)
    {
        ...
        if($this->birthdayDate){
            $query->andFilterWhere(['birthday'=>strtotime($this->birthdayDate)]);
        }
