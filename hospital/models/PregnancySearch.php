...
class PregnancySearch extends Pregnancy
{
    ...
    public function rules()
    {
        return [
            ...
            [['field5a','field5b','contract1','contract2','field0', 'field1','field2','field11','field12', 'field4', 'field6', 'field10', 'field25', 'field26', 'field27', 'field33', 'field34', 'field36', 'field37', 'field38', 'field42', 'field44', 'field59', 'field66', 'field75', 'field79', 'field82', 'field86'], 'safe'],
    ...
    public function search($params)
    {
        ...
        if ($this->field5a !== '' and $this->field5b !== null) {
            $state = strtotime($this->field5a);
            $end = strtotime($this->field5b);
            $query->andFilterWhere(['>=', 'pregnancy.field5', $state]);
            $query->andFilterWhere(['<=', 'pregnancy.field5', $end]);
        }
