...
use hospital\models\message\MessageSearchModel;
...
class MessageController extends BaseController
{
    ...
    {
        $model = new \hospital\models\message\Message();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if( $model->save()) {
                ...
                //获取年龄范围
                $mouth= ChildInfo::getChildType($model->type);
                ...
                if($child) {
                    foreach ($child as $k => $v) {
                        if($touser = UserLogin::findOne(['userid' => $v->userid])->openid) {
                            //微信模板消息
                            $data = [
                            ...
                            $return = WechatSendTmp::send($data, $touser, \Yii::$app->params['yiyuan'], $model->url);
                        }
                    }
                }
