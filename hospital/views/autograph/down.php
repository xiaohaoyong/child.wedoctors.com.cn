...
<div style="padding: 50px;">
    ...
    <div class="content1" style="line-height: 50px;">
        ...
        <div class="content2" style="text-indent: 2em;">
            您好！感谢您选择朝阳区社区卫生服务中心团队签约，为了更好地提供连续性健康管理服务，请您仔细填写以下基本信息，您的个人信息我们将妥善保管：
        </div>
    </div>
    <div style="line-height: 70px;text-indent: 2em;">
        ...
        <div>□高血压患者签约服务包 □2型糖尿病患者签约服务包 □育龄妇女签约服务包 □0-6岁儿童签约服务包 □重点人群身心健康签约服务包 □65岁及以上老年人签约服务包</div>
        ...
        <div>
            本协议期限为一年，一年后自动解约。如需续约请及时与您的家庭医生团队成员联系，办理续约手续。如涉及已经收费的服务项目在签约期内未能完成，经双方协商可延期3个月提供服务或退费。在签约期内，您如果因居住地变更等客观原因，可终止现有的签约服务关系，并可根据实际情况重新启动签约程序。
        </div>
        <?php $autograph=\common\models\Autograph::findOne(['userid'=>$userid]); ?>
        <div>本协议一式二份，双方各执一份，自 <?=date('Y年m月d日',$autograph->createtime)?> 至 <?=date('Y年m月d日',strtotime('+1 year',$autograph->createtime))?> 止。</div>
    </div>
