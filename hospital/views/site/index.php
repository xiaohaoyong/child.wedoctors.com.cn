...
<div class="col-xs-12">
    ...
    <div class="row">
        <?php if (Yii::$app->user->identity->county == 1105 || in_array(Yii::$app->user->identity->hospitalid,[110586,110582,110583,110584,110589,110578,110571,110581,110590,110591,110593,110592,110594,110595,110596,110597,110598,110599,110602,110601,110603,110604,110605,110606,110607])) {?>
    ...
    <?php if (Yii::$app->user->identity->county == 1105 || in_array(Yii::$app->user->identity->hospitalid,[110586,110582,110583,110584,110589,110578,110571,110581,110590,110591,110593,110592,110594,110595,110596,110597,110598,110599,110602,110602,110601,110603,110604,110605,110606,110607])) {?>
