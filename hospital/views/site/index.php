...
<div class="col-xs-12">
    ...
    <div class="row">
        <?php if (Yii::$app->user->identity->county == 1105 || in_array(Yii::$app->user->identity->hospitalid,[110586,110582,110583,110584,110589,110578,110571,110581,110590,110591])) {?>
    ...
    <?php if (Yii::$app->user->identity->county == 1105 || in_array(Yii::$app->user->identity->hospitalid,[110586,110582,110583,110584,110589,110571,110590,110591])) {?>
