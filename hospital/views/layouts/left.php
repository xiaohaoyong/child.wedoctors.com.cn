                ...
                'items' => [
                    ...
                    ['label' => '医生管理', 'icon' => 'file-text-o', 'url' => "#",
                        'items' => [
                            ...
                            ['label' => '家医团队数据同步', 'url' => ['doctor-team/data']],
