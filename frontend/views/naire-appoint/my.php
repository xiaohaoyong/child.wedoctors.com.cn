...
<div class="my">
    <div class="header">
        <a href="/naire-appoint/my?type=1" class="item <?=$type==1?'on':''?>" >进行中</a>
        <a href="/naire-appoint/my?type=2" class="item <?=$type==2?'on':''?>" >已完成</a>
        <a href="/naire-appoint/my?type=3" class="item <?=$type==3?'on':''?>" >已取消</a>
        <a href="/naire-appoint/my?type=4" class="item <?=$type==4?'on':''?>" >已过期</a>
    </div>
    ...
    <div class="content">
        ...
        <div class="myrow">
            <div class="title">
                ...
                <div class="button">
                    <?php if($v['state']==1 || $v['state']==5){?>
                        <a href="/naire-appoint/state?id=<?=$v['id']?>&type=1" class="cancel">取消预约</a>
            ...
            <div>
                <?php if($type==1){?><a href="/naire-appoint/view?id=<?=$v['id']?>"> <?php }?>
