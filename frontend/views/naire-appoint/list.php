        ...
        <div class="list">
            ...
            foreach ($doctors as $k => $v) {
                ...
                <div class="item">
                    <div class="item-content" data-toggle="modal" data-target="#create-modal<?= $v['userid'] ?>">
                        ...
                        <div class="hospital">
                            ...
                            <?php if ($v['week']) { ?>
                                <div class="address">工作时间：每周工作日 <?= implode('，', $v['week']) ?></div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="rad">注：请仔细阅读温馨提示，并确认是否可在本社区检测后预约</div>
                </div>
                ...
                <div class="modal_body">
                    ...
                    <?= str_replace("\n", "<br>", $v['appoint_intro']) ?>
                    <?php if ($v['week']) { ?>
                        <?= \yii\bootstrap\Html::a('去预约', ['naire-appoint/form', 'doctorid' => $v['userid'],'id' => 3], ['class' => 'button']) ?>
                    <?php } else { ?>
                        <div class="button on">暂未开通</div>
                    <?php } ?>
                </div>
