...
<div class="wrapper appoint_list">
    <div class="content-wrapper">
        ...
        <div class="fo" style="margin-top: 100px">
            <a class="button" href="weixin://dl/business/?appid=<?=\Yii::$app->params['doctor_AppID']?>&path=subpackage/reservation/vaccine&query=<?=urlencode('type=13&hospitalId=184793')?>" >
                点击进入小程序预约
            </a>
