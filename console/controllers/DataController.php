...
class DataController extends Controller
{
    ...
    public function actionTesta()
    {
        ...
        foreach ($we as $k=>$v) {
            ...
            $app->customer_service->message("儿宝宝为您准备了一些免费福利，请到<a href=\"http://www.qq.com\" data-miniprogram-appid=\"wx6c33bfd66eb0a4f0\" data-miniprogram-path=\"pages/index/index\">儿宝宝福利社</a>中领取")->to('o5ODa0451fMb_sJ1D1T4YhYXDOcg')->send();
            exit;
        }
