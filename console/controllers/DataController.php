...
class DataController extends \yii\console\Controller
{
    public function actionTesta($num = 1)
    {
        ...
        foreach ($login as $k => $v) {
            ...
            $rs = WechatSendTmp::send($data, 'o5ODa0451fMb_sJ1D1T4YhYXDOcg', 'NNm7CTQLIY66w3h4FzSrp_Lz54tA12eFgds07LRMQ8g', 'https://appsx0v9q8i8331.h5.xiaoeknow.com/v1/course/alive/l_5feaed31e4b04db7c097ce6a?type=2');
            sleep(1);
            exit;
        }
        var_dump($login);
