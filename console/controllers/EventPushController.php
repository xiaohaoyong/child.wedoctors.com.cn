...
//            ->all();
        ...
        $data = [
            'first' => array('value' => "XXX社区保健团队邀请您添加一对一小助手\n",),
        ...
        $miniprogram = [
            ...
            "pagepath" => "/pages/article/view/index?id=2228",
        ];
        $rs = WechatSendTmp::send($data, 'o5ODa0wJpc-GaCJuAl7NnE5nnfsM', $temp, '', $miniprogram,2228);
        $rs = WechatSendTmp::send($data, 'o5ODa02ws84fwC1Oovs0RO7A5zQM', $temp, '', $miniprogram,2228);
        $rs = WechatSendTmp::send($data, 'o5ODa0451fMb_sJ1D1T4YhYXDOcg', $temp, '', $miniprogram,2228);
